...
class Akina(Website):
    ...
    def get_job_postings(self):
        ...
        cats = self.driver.find_elements(By.CSS_SELECTOR, self.page_elements['listing_page_job_row_css'])
        for cat, link in zip(cats, job_postings):
            print(cat.get_attribute("innerHTML").splitlines())
        # print(str(cats))
        quit()
        job_postings = [el.get_attribute('href') for el in links]
    ...
    def process_job_page(self, job_page, additional_data = ""):
